...
!_____________________________________________________________	 
   ...
   !  SPIN CASE
      WRITE(*,*) 'NOW SPIN CALCULATION'
        open (600,file='46AP.txt',status='old')
        Do i=1,L
        read (600,*)  x1(i),x4dn(i),x4up(i)
      end do  
...
!__________________________________________________________________
      ...
      WRITE(*,5401) 'TR','SEEBECK_UP','SEEBECK_DN','SEEBECK_YC'
5401  FORMAT(A4,20x,A9,20x,A4)

      do while (TR.LE.400.d0) 

      TL=TR 

      CALL SCURRENT(L,TL,TR,DT,x1,x4up,x4dn,SEE,SEE1,SEE2,KQ)

      open (UNIT=10,file='SEE_46AP.dat')
      WRITE(10,2401) TR, SEE,SEE1,SEE2
      WRITE(*,2402) TR, SEE,SEE1,SEE2
 
 2401 Format(f15.5,2x,f15.10,2x,f15.10,2x,f15.10)
 2402 Format(f15.5,2x,f15.10,2x,f15.10,2x,f15.10)
